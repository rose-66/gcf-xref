...
{% call statement('raw_wow_region_orders_summary', fetch_result=False) %}
CREATE OR REPLACE EXTERNAL TABLE `{{ target.project }}.slv_xref.ext_wow_region_orders_summary`
(
    region STRING,
    modality STRING,
    leader STRING,
...
OPTIONS (
    format = 'CSV',
    uris = ['gs://xref-ext-tables/fixed_vs_adg_orders/ingestion_timestamp=20251002_154335/raw_wow_region_orders_summary.csv'],
    skip_leading_rows = 2,
    field_delimiter = ',',
